...
Usage:
    python run_parallel_simple.py --workers 10 --episodes 100
"""
...
def main():
    ...
    parser.add_argument('--base_dir', type=str,
                       default='/home/najo/NAS/VLA/Insertion_VLA_Sim/Sim/collected_data_sim_6d',
                       help='Base output directory')
    args = parser.parse_args()

    print("=" * 80)
    print("🚀 Parallel Simulation Data Collection (With Domain Randomization)")
    print("=" * 80)
