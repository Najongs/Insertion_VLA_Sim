...
def main():
    ...
    with h5py.File(FILE_PATH, 'r') as f:
        ...
        while True:
            ...
            # EE Pose: 6D (position + orientation)
            if len(cur_ee) >= 6:
            ...
            cv2.putText(info_panel, q_str, (20, 50), font, 0.5, white, 1)
            cv2.putText(info_panel, a_str, (20, 75), font, 0.5, (100, 255, 255), 1) # Action은 노란색
            cv2.putText(info_panel, ee_str_pos, (20, 100), font, 0.5, white, 1)
            cv2.putText(info_panel, ee_str_rot, (20, 125), font, 0.5, white, 1)
